...
@interface UIBarButtonItem (CHBase)
 ...
 */
+ (UIBarButtonItem *)ch_barButtonItemWithImage:(UIImage *)image
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (UIBarButtonItem *)ch_barButtonItemWithTitle:(NSString *)title
                                         style:(UIBarButtonItemStyle)style
                                        target:(id)target
                                        action:(SEL)action;
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (UIBarButtonItem *)ch_barButtonItemWithBarButtonSystemItem:(UIBarButtonSystemItem)systemItem
                                                      target:(id)target
                                                      action:(SEL)action;
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (nullable UIBarButtonItem *)ch_barButtonItemWithCustomView:(UIView *)customView
                                             target:(id)target
                                             action:(SEL)action;
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (nullable UIBarButtonItem *)ch_barButtonItemWithCustomView:(UIView *)customView actionBlock:(void (^)(id sender))actionBlock;
