//
//  NSString+CHRegularExpression.h
//  Pods
//
...
@interface NSString (CHRegularExpression)
 ...
 */
- (void)ch_enumerateRegexMatches:(NSString *)regex
...
/**
 ...
 @return 新字符串
 */
- (NSString *)ch_stringByReplacingRegex:(NSString *)regex
                                options:(NSRegularExpressionOptions)options
